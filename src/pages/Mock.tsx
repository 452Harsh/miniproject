...
const Mock = () => {
  ...
  return (
    <div>
      {submit ? (
       <div> <Navbar/>
       <div className=" m-12 border-8 border-blue-500 h-32 w-32 rounded-full grid justify-items-center content-center ">
        
          <div>8/10</div>
          <div>Your score</div>
        
       </div>
       <div className="mx-12 text-bold font-serif">Successful submit</div>
       <div className="mx-12 text-bold font-serif text-sky-400/100">Review you annswer</div>
        </div>
      ) : (
        <div className="bg-white">
          <div className=" flex ">
            <div className="w-3/4 h-12">
              ...
              <div
                style={{ marginTop: 470 }}
                className="LowerSection flex pl-20 py-4 bg-gray-200 border-2 border-gray-300"
              >
                ...
                <button
                  ...
                  className="ml-96 bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded-full"
                >
                  Submit Test
                </button>
              </div>
                      ...
                      <button
                        ...
                        style={{
                          backgroundColor: answers[question.id]
                            ? answers[question.id] ===
                              questions[question.id - 1].answer
                              ? "red"
                              : "red"
                            : "green",
                        }}
